...
async def _(event):
    ...
    me = borg.me
    userid = borg.uid
    packname = f"@HafizZiq 's Kang Pack 4"
    packshortname = f"Id_667676317_kp4"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"Animated Pack by @HafizZiq"
        packshortname = f"Id_667676317_as"  # format: Uni_Borg_userid
    ...
    await event.edit(f"▕╮╭┻┻╮╭┻┻╮╭▕╮╲\n▕╯┃╭╮┃┃╭╮┃╰▕╯╭▏\n▕╭┻┻┻┛┗┻┻┛   ▕   ╰▏\n▕╰━━━┓┈┈┈╭╮▕╭╮▏\n▕╭╮╰┳┳┳┳╯╰╯▕╰╯▏\n▕╰╯┈┗┛┗┛┈╭╮▕╮┈▏\n\n[Sticker looted ( ͝° ͜ʖ͡°)ᕤ](t.me/addstickers/{packshortname})")
